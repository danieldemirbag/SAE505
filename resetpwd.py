...
"background: rgba(255, 255, 255, 0);")
        ...
        self.resetbouton = QtWidgets.QToolButton(self.widget)
        self.resetbouton.setGeometry(QtCore.QRect(200, 550, 250, 70))
        font = QtGui.QFont()
        font.setPointSize(16)
        self.resetbouton.setFont(font)
        self.resetbouton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.resetbouton.setAutoFillBackground(False)
        self.resetbouton.setStyleSheet("background: rgba(255, 255, 255, .5);\n"
"border: 2px solid;\n"
"border-radius: 10px;")
        self.resetbouton.setCheckable(False)
        self.resetbouton.setAutoExclusive(False)
        self.resetbouton.setAutoRepeatInterval(100)
        self.resetbouton.setObjectName("resetbouton")
...
"border-radius: 30px;")
    ...
    def retranslateUi(self, reset):
        ...
        self.resetbouton.setText(_translate("reset", "Réinitialiser"))
