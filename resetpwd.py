...
"border-radius: 20px;")
        ...
        self.logtitre.setGeometry(QtCore.QRect(30, 125, 591, 70))
        font = QtGui.QFont()
...
"border-radius: 30px;")
    ...
    def retranslateUi(self, Login):
        ...
        self.logtitre.setText(_translate("Login", "Réinitialiser mot de passe"))
        self.lognomuser.setPlaceholderText(_translate("Login", "Email"))
        self.logmdp.setPlaceholderText(_translate("Login", "Utilisateur"))
        self.logboutoncon.setText(_translate("Login", "Réinitialiser"))
